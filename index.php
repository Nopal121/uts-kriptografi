...
function caesarEncrypt($text, $shift){
    ...
    for($i = 0; $i < strlen($text); $i++){
        ...
        if(ctype_alpha($char)){
            ...
            $result .= chr(
                (($char = ord($char) - $ascii + $shift) % 26) + $ascii
            );
...
<div class="header">
    ...
    <p>Web Tools Kriptografi Berbasis PHP</p>
...
Aplikasi ini merupakan <strong>Super App Kriptografi</strong>
berbasis PHP yang menggabungkan berbagai tools keamanan data,
algoritma kriptografi klasik dan modern, serta matematika kriptografi
dalam satu halaman web modern dan responsif.
</p>

<br>

<p style="line-height:1.9;">
Project ini dibuat untuk memenuhi tugas praktikum
<strong>Mata Kuliah Kriptografi</strong>
dengan konsep
<strong>Project Based Learning (PjBL)</strong>
dan
...
<p>
Kriptografi modern menggunakan public key dan private key.
</p>
...
<p>
Generate RSA Key, CSR, dan SSL Certificate menggunakan OpenSSL.
</p>
...
<button class="btn-primary" name="encrypt">Encrypt</button>

<button class="btn-secondary" name="decrypt">Decrypt</button>
...
<textarea><?= htmlspecialchars($encrypted) ?></textarea>
...
if(isset($_POST['generate_ssl'])){
    ...
    if(!$privkey){
        ...
        $error = "Gagal membuat Private Key";
...
<button class="btn-primary" name="generate_ssl">
Generate SSL
</button>
...
<textarea><?= htmlspecialchars($privateKeyOut) ?></textarea>

<hr>

<strong>CSR:</strong>

<textarea><?= htmlspecialchars($csrOut) ?></textarea>

<hr>

<strong>SSL Certificate:</strong>

<textarea><?= htmlspecialchars($certOut) ?></textarea>
